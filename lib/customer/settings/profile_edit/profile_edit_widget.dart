                                ...
                                InkWell(
                                  ...
                                  onTap: () async {
                                    ...
                                    if (selectedMedia != null &&
                                      ...
                                      safeSetState(() =>
                                          _model.isDataUploading_atualizarFoto =
                                              true);
                                      ...
                                      if (selectedUploadedFiles.length ==
                                          ...
                                          downloadUrls.length ==
                                              selectedMedia.length) {
                                        safeSetState(() {
                                          _model.uploadedLocalFile_atualizarFoto =
                                              selectedUploadedFiles.first;
                                          _model.uploadedFileUrl_atualizarFoto =
                                              downloadUrls.first;
                                        });
                                      } else {
                                        safeSetState(() {});
                            ...
                            Container(
                              ...
                              child: TextFormField(
                                controller: _model.textController3 ??=
                                    TextEditingController(
                                  text: functions.dataAniversaio(
                                      columnUsersRow?.dateOfBirth),
                                ),
