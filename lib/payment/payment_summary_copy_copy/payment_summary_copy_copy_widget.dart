...
import 'payment_summary_copy_copy_model.dart';
export 'payment_summary_copy_copy_model.dart';

class PaymentSummaryCopyCopyWidget extends StatefulWidget {
  const PaymentSummaryCopyCopyWidget({super.key});

  static String routeName = 'PaymentSummaryCopyCopy';
  static String routePath = '/paymentSummaryCopyCopy';

  @override
  State<PaymentSummaryCopyCopyWidget> createState() =>
      _PaymentSummaryCopyCopyWidgetState();
}

class _PaymentSummaryCopyCopyWidgetState
    extends State<PaymentSummaryCopyCopyWidget> {
  late PaymentSummaryCopyCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PaymentSummaryCopyCopyModel());
                          ...
                          if (_model.valorint! >= 2) {
                            ...
                            if (_model.walletExiste != null &&
                              ...
                              if ((_model.linkCheckout?.succeeded ?? true)) {
                                ...
                                int retryCountWalletValue = 0;
                                bool paymentSucceededWallet = false;
                                while (retryCountWalletValue < 30 &&
