...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF211A40);
  late Color secondary = const Color(0xFF6503AD);
  late Color tertiary = const Color(0xFF944393);
  late Color alternate = const Color(0xFF35383F);
  late Color primaryText = const Color(0xFFFFFFFF);
  late Color secondaryText = const Color(0xFFA1A2A7);
  late Color primaryBackground = const Color(0xFF191A1F);
  late Color secondaryBackground = const Color(0xFF1F222B);
  late Color accent1 = const Color(0xFFC24D98);
  late Color accent2 = const Color(0xA4C24D98);
  late Color accent3 = const Color(0x4CDF585A);
